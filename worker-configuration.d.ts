/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6b73b30446a3495417411ca77b30cff)
// Runtime types generated with workerd@1.20251118.0 2025-01-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		DRIZZLE_ACCOUNT_ID: string;
		DRIZZLE_DATABASE_ID: string;
